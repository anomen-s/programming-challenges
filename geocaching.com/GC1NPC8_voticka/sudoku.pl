...
sel(List, Item, Rest) :- select(Item, List, Rest).
...
% RADEK1
	sel(N,	 A1,R1C1),	sel(N,	 A1,Q11a),	sel(N,	 A1,C1C1), 	A1=\=7, A1=\=4,
	sel(R1C1,B1,R1C2),	sel(Q11a,B1,Q11b),	sel(N,	 B1,C2C1),
	sel(R1C2,C1,R1C3),	sel(Q11b,C1,Q11c),	sel(N,	 C1,C3C1),	C1=\=3,
	member(9, [A1,C1]),
	sel(R1C3,D1,R1C4),	sel(N,	 D1,Q12a),	sel(N,	 D1,C4C1),	D1=\=4,D1=\=7,
	sel(R1C4,E1,R1C5),	sel(Q12a,E1,Q12b),	sel(N,	 E1,C5C1),
	sel(R1C5,F1,R1C6),	sel(Q12b,F1,Q12c),	sel(N,	 F1,C6C1),	F1=\=5, F1=\=6,
	sel(R1C6,G1,R1C7),	sel(N,	 G1,Q13a),	sel(N,	 G1,C7C1),
	sel(R1C7,H1,R1C8),	sel(Q13a,H1,Q13b),	sel(N,	 H1,C8C1),	member(H1, [5,7,8]),
	sel(R1C8,I1,[]),	sel(Q13b,I1,Q13c),	sel(N,	 I1,C9C1),	I1=\=2,I1=\=8,

% RADEK-2
	sel(N,	 A2,R2C1),	sel(Q11c,A2,Q11d),	sel(C1C1,A2,C1C2),	A2=\=7, A2=\=4,
	sel(R2C1,B2,R2C2),	sel(Q11d,B2,Q11e),	sel(C2C1,B2,C2C2),	
	sel(R2C2,C2,R2C3),	sel(Q11e,C2,Q11f),	sel(C3C1,C2,C3C2),	C2=\=3,
	member(4, [C1,C2]),
	sel(R2C3,D2,R2C4),	sel(Q12c,D2,Q12d),	sel(C4C1,D2,C4C2),	D2=\=4,D2=\=7,
	sel(R2C4,E2,R2C5),	sel(Q12d,E2,Q12e),	sel(C5C1,E2,C5C2),	
	sel(R2C5,F2,R2C6),	sel(Q12e,F2,Q12f),	sel(C6C1,F2,C6C2),	F2=\=5, F2=\=6,
	sel(R2C6,G2,R2C7),	sel(Q13c,G2,Q13d),	sel(C7C1,G2,C7C2),	G2=\=5, G2=\=7,
	sel(R2C7,H2,R2C8),	sel(Q13d,H2,Q13e),	sel(C8C1,H2,C8C2),	
	sel(R2C8,I2,[]),	sel(Q13e,I2,Q13f),	sel(C9C1,I2,C9C2),	I2=\=2,I2=\=8,


% RADEK-3
	sel(N,	 A3,R3C1),	sel(Q11f,A3,Q11g),	sel(C1C2,A3,C1C3),	A3=\=7, A3=\=4,
	sel(R3C1,B3,R3C2),	sel(Q11g,B3,Q11h),	sel(C2C2,B3,C2C3),	B3=\=4,B3=\=9,
	...
	sel(R3C7,H3,R3C8),	sel(Q13g,H3,Q13h),	sel(C8C2,H3,C8C3),	H3=\=1,H3=\=6,
	sel(R3C8,I3,[]),	sel(Q13h,I3,[]),	sel(C9C2,I3,C9C3),	I3=\=2,I3=\=8,
...
% RADEK-4
	...
	sel(R4C2,C4,R4C3),	sel(Q21b,C4,Q21c),	sel(C3C3,C4,C3C4),	member(C4, [1,2,9]),
...
% RADEK-5
	sel(N,	 A5,R5C1),	sel(Q21c,A5,Q21d),	sel(C1C4,A5,C1C5),	member(A5,[6,8,9]),
	...
	sel(R5C4,E5,R5C5),	sel(Q22d,E5,Q22e),	sel(C5C4,E5,C5C5),	member(E5,[3,4,5]),
...
% RADEK-7
	...
	sel(R7C4,E7,R7C5),	sel(Q32a,E7,Q32b),	sel(C5C6,E7,C5C7),	
...
%sloupce
	...
	%printboard(Board), %debug
	Res=[n(5,0,0,E5,A8,I4,E1),e(0,1,4,2,A5,A3,G1,C5),a(C4),b(H1)].
